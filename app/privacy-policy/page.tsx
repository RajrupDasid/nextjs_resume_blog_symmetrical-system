const Privacy = () => {
  return (
    <div>
      <h1>Privacy Policy for Webstackpros.net</h1>

      <p>
        At webstackpros.net, accessible from https://webstackpros.net, one of
        ...
        webstackpros.net and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in webstackpros.net. This policy is not applicable
      ...
      <p>
        webstackpros.net follows a standard procedure of using log files. These
      ...
      <p>
        Like any other website, webstackpros.net uses cookies. These cookies are
      ...
      <p>
        ...
        advertising partners of webstackpros.net.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on webstackpros.net, which are sent
      ...
      <p>
        Note that webstackpros.net has no access to or control over these
      ...
      <p>
        webstackpros.nets Privacy Policy does not apply to other advertisers or
      ...
      <p>
        webstackpros.net does not knowingly collect any Personal Identifiable
